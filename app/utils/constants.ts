...
const staticModels: ModelInfo[] = [
  ...
  { name: 'llama-3.2-11b-vision-preview', label: 'Llama 3.2 11b-vision (Groq)', provider: 'Groq' },
  { name: 'llama-3.2-90b-vision-preview', label: 'Llama 3.2 90b-vision (Groq)', provider: 'Groq' },  
